...
const BookCard = (props) => {
  return (
    <div
      className="card card-compact bg-transparent shadow-xl mb-2 pt-2 max-w-[160px] h-[250px] p-0 xs:max-w-[200px] xs:max-h-[300px] hover:bg-slate-300 cursor-pointer"
      key={props.isbn}
    >
