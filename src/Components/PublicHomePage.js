  ...
  render() {
    return (
      <div className="container mx-auto px-4">
        ...
        <div className="flex place-content-center text-base-content text-2xl text-black">
        ...
        <div className="">
          ...
          <br />
          <Link className="flex w-full place-content-center text-slate-500" to="registration">
            Register
          </Link>
        </div>
      </div>
